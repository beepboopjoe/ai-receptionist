// ============================================================
// /dental — Phase 16. Public marketing landing for dental practices.
// Composes the vertical-landing kit with content.dental.
// ============================================================
    ...
    <div className="min-h-screen bg-cream-50">
      ...
      <section className="py-20 px-6 bg-cream-50">
        <div className="max-w-5xl mx-auto">
          ...
          <SampleCallPlayer vertical="dental" callType="inbound" />
        </div>
      </section>
