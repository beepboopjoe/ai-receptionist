// ============================================================
// /real-estate — Phase 16. Public marketing landing for real estate brokerages.
// Composes the vertical-landing kit with content.real_estate.
// ============================================================
    ...
    <div className="min-h-screen bg-cream-50">
      ...
      <section className="py-20 px-6 bg-cream-50">
        <div className="max-w-5xl mx-auto">
          ...
          <SampleCallPlayer vertical="real_estate" callType="inbound" />
        </div>
      </section>
