...
export default function OutboundPage() {
  return (
    <div className="min-h-screen bg-cream-50 text-cream-900">
      ...
      {/* ── No list? section (Phase 12.7 — Lead Discovery callout) ─── */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <h2 className="font-serif text-4xl text-cream-900 tracking-tight">
                No list? We&apos;ll find them for you.
              </h2>
              <p className="text-cream-600 mt-3 leading-relaxed">
                Tell us who you want to call — &ldquo;dentists in Chicago, rated 3.5+, with a phone number&rdquo;
                — and we scrape real, current businesses from Google Maps. Review every lead, import the
                ones you keep. <strong className="text-cream-900">$0.99 per lead</strong>, no list-broker
                middleman, no stale CSVs.
              </p>
              <ul className="space-y-2 mt-5">
                {[
                  'Phone, address, rating, website included',
                  'Filter by location, radius, category, rating',
                  'You pay only for leads you actually import',
                  'Imports straight into a draft outbound campaign',
                ].map((f) => (
            ...
            <div className="rounded-2xl border border-cream-200 bg-cream-50 p-5 shadow-sm">
              <div className="rounded-xl bg-white border border-cream-200 p-4 space-y-2">
                <p className="text-[10px] font-bold text-brand-700 uppercase tracking-wider">Sample search</p>
                <div className="space-y-2 text-sm">
                  <div className="flex items-center gap-2">
                    <span className="text-cream-500">Query:</span>
                    <span className="font-medium text-cream-900">coffee shops</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-cream-500">Location:</span>
                    <span className="font-medium text-cream-900">Brooklyn, NY · 5 miles</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-cream-500">Rating:</span>
                    <span className="font-medium text-cream-900">4.0+</span>
                  </div>
                </div>
                <div className="border-t border-cream-100 pt-3 mt-3">
                  <p className="text-xs text-cream-600">
                    ≈ <span className="font-bold text-cream-900 tabular-nums">52</span> leads ·{' '}
                    <span className="font-bold text-brand-700 tabular-nums">$51.48</span> max
                  </p>
                </div>
              </div>
              <p className="text-[11px] text-cream-500 mt-3 text-center">
                Real Google Maps data, refreshed every search.
              </p>
            </div>
          </div>
        </div>
