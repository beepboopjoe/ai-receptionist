...
> = {
  usage_limit: {
    ...
    description: "You've used 80%+ of your monthly AI minutes. Upgrade to Growth for 3× the capacity before calls start being dropped.",
    features: [
      '3,000 AI minutes/month (vs 1,000)',
      'Priority support',
      'Outbound campaign access',
    ],
    cta: 'Upgrade to Growth · $399/mo',
    targetPlan: 'Growth',
  },
  outbound_locked: {
    icon: '📣',
    title: 'Outbound campaigns require Growth',
    description: 'AI calling campaigns — dial lead lists, qualify prospects, and book appointments automatically — are available on Growth and Pro plans.',
    features: [
  ...
  second_number: {
    icon: '📱',
    title: 'Additional phone numbers require Growth',
    description: 'Adding a second location or phone line is available on Growth and Pro plans.',
    features: [
      '2 phone numbers on Growth',
      'Up to 5 locations on Pro',
  ...
  pro_analytics: {
    icon: '📊',
    title: 'Advanced analytics require Pro',
    description: 'Call quality scores, conversion funnels, and custom reports — available on Pro plan.',
    features: [
      'Call quality scoring per conversation',
      'Conversion funnel analytics',
      'Custom report builder & CSV export',
    ],
    cta: 'Upgrade to Pro · $799/mo',
    targetPlan: 'Pro',
  },
  multi_location: {
    icon: '🏢',
    title: 'Multi-location management requires Pro',
    description: 'Manage up to 5 practice locations, each with its own phone number and AI configuration.',
    features: [
