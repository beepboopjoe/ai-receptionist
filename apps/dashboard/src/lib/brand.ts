// ============================================================
// Brand — single source of truth for product naming and tagline.
// Import these constants instead of hardcoding strings so a future
...
export const BRAND_AGENT_NAME = 'Telfin';
