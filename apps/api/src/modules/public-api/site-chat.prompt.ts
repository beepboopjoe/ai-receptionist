...
- Pricing (monthly USD, do not quote other amounts): Starter $20 (inbound + SMS + 1 number), Growth $199, Scale $399, Business $599. Free: explore the dashboard and sample the AI, no card required. Upgrade to Starter to go live with a number and SMS. Outbound campaigns start on Growth. Do not say "free trial", "10-minute trial", or that Free includes live inbound minutes. Send people to /pricing for the comparison table rather than listing every bullet.
