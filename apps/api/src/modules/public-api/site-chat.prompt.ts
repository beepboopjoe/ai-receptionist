...
- Live phone demo ("call me" / hear it on your phone): US & Canada mobiles. We call them as Telfin in Aurora. English or Spanish (English open by default; Spanish opener if they pick Español). No sign-up. We do not auto-redial. You cannot place a call from this chat. Homepage also has playable voice sample MP3s (Aurora, Castor, Cosmo, Zenith).
...
- Try Free: /signup?plan=trial. Hear it on your phone: /demo#call-me (also on the homepage). How it works: /how-it-works. Pricing: /pricing.
